...
import com.anserx.pengyan.common.response.BaseResponse;
import lombok.AllArgsConstructor;
import lombok.Getter;

@Getter
@AllArgsConstructor
public enum CommonResponseEnum implements ArgumentExceptionAssert {
    /**
     * 成功
     */
    SUCCESS(0, "SUCCESS"),
    ...
    /**
     * 5***，一般对应于{@link com.anserx.pengyan.common.exception.ArgumentException}，系统封装的工具出现异常
     */
